...
CREATE POLICY "Allow all for authenticated users" ON public.team_users
...
CREATE POLICY "Allow all for authenticated users" ON public.team_availability
FOR ALL TO authenticated
USING (true)
WITH CHECK (true);
...
CREATE POLICY "Allow all for authenticated users" ON public.client_products
FOR ALL TO authenticated
USING (true)
WITH CHECK (true);
...
CREATE POLICY "Allow all for authenticated users" ON public.client_tasks
FOR ALL TO authenticated
USING (true)
WITH CHECK (true);
...
CREATE POLICY "Allow all for authenticated users" ON public.setters
FOR ALL TO authenticated
USING (true)
WITH CHECK (true);
...
CREATE POLICY "Allow all for authenticated users" ON public.setter_meetings
FOR ALL TO authenticated
USING (true)
WITH CHECK (true);
...
CREATE POLICY "Allow all for authenticated users" ON public.closers
FOR ALL TO authenticated
USING (true)
WITH CHECK (true);
...
CREATE POLICY "Allow all for authenticated users" ON public.closer_calls
FOR ALL TO authenticated
USING (true)
WITH CHECK (true);
...
CREATE POLICY "Allow all for authenticated users" ON public.call_recordings
FOR ALL TO authenticated
USING (true)
WITH CHECK (true);
...
CREATE POLICY "Allow all for authenticated users" ON public.documents
FOR ALL TO authenticated
USING (true)
WITH CHECK (true);
...
CREATE POLICY "Allow all for authenticated users" ON public.incomes
FOR ALL TO authenticated
USING (true)
WITH CHECK (true);
...
CREATE POLICY "Allow all for authenticated users" ON public.fixed_costs
FOR ALL TO authenticated
USING (true)
WITH CHECK (true);
...
CREATE POLICY "Allow all for authenticated users" ON public.variable_costs
FOR ALL TO authenticated
USING (true)
WITH CHECK (true);
...
CREATE POLICY "Allow all for authenticated users" ON public.monthly_accounting
FOR ALL TO authenticated
USING (true)
WITH CHECK (true);
...
CREATE POLICY "Allow all for authenticated users" ON public.announcements
FOR ALL TO authenticated
USING (true)
WITH CHECK (true);
...
CREATE POLICY "Allow all for authenticated users" ON public.time_audit_tasks
FOR ALL TO authenticated
USING (true)
WITH CHECK (true);
...
CREATE POLICY "Allow all for authenticated users" ON public.user_performance
FOR ALL TO authenticated
USING (true)
WITH CHECK (true);