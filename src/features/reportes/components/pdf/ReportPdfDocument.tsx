...
// drift apart.
export function ReportPdfDocument({ clientName, periodLabel, metrics, trend, narrativa }: ReportPdfDocumentProps) {
  return (
    <div>
      <CoverPage clientName={clientName} periodLabel={periodLabel} />
